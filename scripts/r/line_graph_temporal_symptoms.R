...
title = "/Users/bengels/Desktop/stage_umcg2022/scripts/Pipeline/Output/linegraphs/"
df_char_vis <- read.csv("/Users/bengels/Desktop/stage_umcg2022/scripts/Pipeline/Output/ouput_pca_fa_kmeans_analysis.csv")
clusts <- colnames(df_char_vis)
df_char_vis$symptom
  ...
  labels <- tibble(
    ...
    label = c("clust1", "clust2", "clust3", "clust4", "", "")
  )
  ...
  ggsave(paste(title, "/", paste("Lineplot", levels, "_years_", end.year,".png")), g,
         width = 16, height = 9, device = ragg::agg_png)
